...
<body>
    ...
    <div style="width: 70%;height:900px;border-width: 2px;margin-left: 30%">
        ...
        <table>
            ...
            <tr>
                <td colspan="12">
                    <a href="creatResumeToRecruitment?resumeId=${sessionScope.resumeDetail.get(0).re_id}"><input type="button" value="选择简历"></a>
                </td>
            </tr>
        </table>
        <%
        ...
        %>
        <a href="sendRecruitment?startPage=<%=i%>&recruitmentId=${sessionScope.sendRecruitmentId}"><%=i%></a>
        <%
